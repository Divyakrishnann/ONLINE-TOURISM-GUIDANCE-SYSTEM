...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		lblName.setBounds(116, 11, 300, 53);
		contentPane.add(lblName);
                
                JLabel la2 = new JLabel("Username :");
                la2.setFont(new Font("Ariel Black", Font.BOLD,17));
		la2.setBounds(35, 73, 200, 15);
		contentPane.add(la2);
		...
		contentPane.add(l1);
                ...
                lblId.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		contentPane.add(lblId);
                ...
                la3.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		t1.setColumns(10);
                ...
                la4.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		JLabel la5 = new JLabel("AC / Non-AC");
                la5.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		JLabel la6 = new JLabel("Food Included :");
                la6.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		JLabel lbl1 = new JLabel("ID :");
                lbl1.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		JLabel lbl2 = new JLabel("Number :");
                lbl2.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		JLabel lbl3 = new JLabel("Phone :");
                lbl3.setFont(new Font("Ariel Black", Font.BOLD, 17));
		...
		JLabel lblDeposite = new JLabel("Total Price :");
                lblDeposite.setFont(new Font("Ariel Black", Font.BOLD, 17));
