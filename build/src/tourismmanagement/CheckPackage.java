...
public class CheckPackage extends JFrame{
    ...
    public JPanel createPackage(String[] pack){
        ...
        lblName.setFont(new Font("Ariel Black", Font.BOLD, 30));
        ...
        lblCheckInStatus.setFont(new Font("Yu Mincho", Font.BOLD, 32));
        lblCheckInStatus.setBackground(Color.RED);
        lblCheckInStatus.setBounds(35, 400, 200, 40);
        p1.add(lblCheckInStatus);

        JLabel lblDeposite = new JLabel(pack[10]);
        lblDeposite.setFont(new Font("Yu Mincho", Font.BOLD, 35));
        lblDeposite.setBackground(Color.RED);
        lblDeposite.setBounds(35, 460, 400, 40);
        p1.add(lblDeposite);
        
        JLabel la1 = new JLabel(pack[11]);
        la1.setForeground(Color.RED);
        la1.setFont(new Font("Yu Mincho", Font.BOLD, 30));
