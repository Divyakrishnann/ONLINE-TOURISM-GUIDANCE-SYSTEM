...
public class Home extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1300, 700); 
        add(NewLabel);
        
        JLabel l1 = new JLabel("Welcome to the Online");
	l1.setForeground(Color.WHITE);
        l1.setFont(new Font("Tahoma", Font.BOLD, 45));
	l1.setBounds(430, 350, 1000, 45);
	NewLabel.add(l1);
        
        JLabel new1 = new JLabel( "Tourism App!");
	new1.setForeground(Color.WHITE);
        new1.setFont(new Font("Tahoma", Font.BOLD, 45));
	new1.setBounds(500, 400, 1000, 45);
	NewLabel.add(new1);
	...
	m6.add(mi14);
        ...
        JMenu m8 = new JMenu("LOCATION");
        m8.setForeground(Color.BLUE);
	menuBar.add(m8);
        
        JMenuItem mi18 = new JMenuItem("MAP");
	m8.add(mi18);
