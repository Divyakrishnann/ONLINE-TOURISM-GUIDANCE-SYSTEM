...
public class BookPackage extends JFrame {
	...
	public BookPackage(String username) {
		...
		lblName.setFont(new Font("Ariel Black", Font.BOLD, 20));
		lblName.setBounds(118, 9, 300, 53);
		contentPane.add(lblName);
                
                JLabel la2 = new JLabel("Username :");
                la2.setFont(new Font("Ariel Black", Font.BOLD, 15));
		la2.setBounds(35, 70, 200, 16);
		contentPane.add(la2);
                
                JLabel l1 = new JLabel(username);
                l1.setFont(new Font("Ariel Black", Font.BOLD, 15));
		l1.setBounds(271, 70, 200, 14);
		contentPane.add(l1);
                
                JLabel lblId = new JLabel("Select Package :");
                lblId.setFont(new Font("Ariel Black", Font.BOLD, 15));
		...
		contentPane.add(lblId);
                ...
                la3.setFont(new Font("Ariel Black", Font.BOLD, 15));
		...
		JLabel lbl1 = new JLabel("ID :");
                lbl1.setFont(new Font("Ariel Black", Font.BOLD, 15));
		...
		JLabel lbl2 = new JLabel("Number :");
                lbl2.setFont(new Font("Ariel Black", Font.BOLD, 15));
		...
		JLabel lbl3 = new JLabel("Phone :");
                lbl3.setFont(new Font("Ariel Black", Font.BOLD, 15));
		...
		JLabel lblDeposite = new JLabel("Total Price :");
                lblDeposite.setFont(new Font("Ariel Black", Font.BOLD, 15));
		...
		contentPane.add(l5);
                ...
                b1.setFont(new Font("Ariel Black", Font.BOLD, 15));
		...
		JButton btnNewButton = new JButton("Book");
                btnNewButton.setFont(new Font("Ariel Black", Font.BOLD, 15));
...
//                    code detective
		...
		JButton btnExit = new JButton("Back");
                btnExit.setFont(new Font("Ariel Black", Font.BOLD, 15));
