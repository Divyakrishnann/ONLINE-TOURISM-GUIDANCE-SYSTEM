...
public class UpdateCustomer extends JFrame {
	...
	public UpdateCustomer(String username) throws SQLException {
		...
		lblName.setBounds(118, 9, 500, 53);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t7.getText(); 
                                ...
                                String q1 = "update customer set id = '"+s2+"', number = '"+s3+"', name = '"+s4+"', gender = '"+s5+"', country = '"+s6+"', address = '"+s7+"', phone = '"+s8+"', emails = '"+s9+"' where username = '"+s1+"'";
